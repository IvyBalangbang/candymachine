...
{
    static Scanner Balangbang = new Scanner(System.in);

  public static void main(String[] args) 
 {
      CashRegister cashRegister = new CashRegister();   //Step 1
      Dispenser melon = new Dispenser(100, 75);         //Step 2
      Dispenser crisp = new Dispenser(100, 65);         //Step 2
...
{
    System.out.println("*** Welcome to Ivy's "
                 + "Candy Shop***");
    System.out.println("To select an item, enter ");
    Ststem.out.println("1 for Candy");
